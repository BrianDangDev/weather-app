...
function setPosition(position){
    let latitute = position.coords.latitute;
    let longtitute = position.coords.longtitute;
    getWeather(latitute, longtitute);
}
...
function getWeather(latitute, longtitute){
    let api = `http://api.openweathermap.org/data/2.5/weather?lat=${latitute}&lon=${longtitute}&appid=${key}`;
    fetch(api)
